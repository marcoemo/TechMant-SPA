...
public class ResenaController {
    ...
    // 🔹 Obtener todas las reseñas -- Usuario
    @GetMapping
    ...
    // 🔹 Crear nueva reseña con validaciones manuales -- cliente
    @PostMapping
    ...
    // 🔹 Obtener reseñas por usuario -- usuarios
    ...
    // 🔹 Obtener una reseña por ID -- usuarios
    @GetMapping("/{id}")
    ...
    // 🔹 Actualizar reseña cliente -- pendiente PUT
}
